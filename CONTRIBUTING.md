...
The SwiftSoundFont maintainers takes security seriously.
...
See [CODE_OF_CONDUCT.md](https://github.com/genedelisa/SwiftSoundFont/blob/master/CODE_OF_CONDUCT.md) for details.
